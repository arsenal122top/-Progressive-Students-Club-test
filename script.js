const team = [
  ...
  },
  {
    ...
    role: "\u0418\u043d\u0442\u0435\u0440\u0432\u044c\u044e \u0438 \u043c\u0435\u0434\u0438\u0430",
    className: "10\u0413",
    description: "\u0421\u043e\u0437\u0434\u0430\u0451\u0442 \u0432\u0438\u0437\u0443\u0430\u043b \u0438 \u043f\u043e\u043c\u043e\u0433\u0430\u0435\u0442 \u043f\u043e\u043a\u0430\u0437\u044b\u0432\u0430\u0442\u044c \u0436\u0438\u0437\u043d\u044c \u043a\u043b\u0443\u0431\u0430.",
    details: "\u041e\u0442\u0432\u0435\u0447\u0430\u0435\u0442 \u0437\u0430 \u0444\u043e\u0442\u043e-\u043a\u043e\u043d\u0442\u0435\u043d\u0442, \u043c\u0435\u0434\u0438\u0430\u043c\u0430\u0442\u0435\u0440\u0438\u0430\u043b\u044b \u0438 \u0432\u0438\u0437\u0443\u0430\u043b\u044c\u043d\u0443\u044e \u043f\u043e\u0434\u0430\u0447\u0443 \u043a\u043b\u0443\u0431\u0430.",
  ...
  className: "10Б",
  description: "Запускает идеи, держит направление клуба и развивает его голос.",
  ...
  {
  name: "Лоянов Ридван",
  role: "\u041a\u043e\u043d\u0442\u0435\u043d\u0442 \u0438 \u0441\u043e\u0446\u0441\u0435\u0442\u0438",
  className: "10\u0410",
  description: "Ведёт соцсети, собирает активность и помогает клубу звучать ярче.",
  ...
  },
  {
    ...
    role: "\u041a\u043e\u043e\u0440\u0434\u0438\u043d\u0430\u0446\u0438\u044f \u0432\u0441\u0442\u0440\u0435\u0447",
    className: "10\u0410",
    description: "\u041f\u043e\u043c\u043e\u0433\u0430\u0435\u0442 \u0434\u0435\u0440\u0436\u0430\u0442\u044c \u0440\u0438\u0442\u043c \u043a\u043e\u043c\u0430\u043d\u0434\u044b \u0438 \u0432\u0441\u0442\u0440\u0435\u0447.",
    details: "\u041a\u043e\u043e\u0440\u0434\u0438\u043d\u0438\u0440\u0443\u0435\u0442 \u0432\u0441\u0442\u0440\u0435\u0447\u0438, \u0441\u043b\u0435\u0434\u0438\u0442 \u0437\u0430 \u043f\u0440\u043e\u0446\u0435\u0441\u0441\u0430\u043c\u0438 \u0438 \u043f\u043e\u043c\u043e\u0433\u0430\u0435\u0442 \u043a\u043e\u043c\u0430\u043d\u0434\u0435 \u0434\u0432\u0438\u0433\u0430\u0442\u044c\u0441\u044f \u0440\u043e\u0432\u043d\u043e.",
...
function createTeamCard(member, { compact = false, interactive = false, featured = false } = {}) {
  ...
  const badges = compact ? [member.className].filter(Boolean) : [member.className, member.role].filter(Boolean);
...
function applyRevealAnimation(elements) {
  ...
  targets.forEach((target, index) => {
    ...
    target.style.setProperty("--reveal-delay", `${Math.min(index * 0.08, 0.32)}s`);
...
function renderTeamPage() {
  ...
  const compactTeamQuery = window.matchMedia("(max-width: 600px)");
  ...
  const draw = () => {
    ...
    const hasActiveFilter = Boolean(selectedRole || selectedClass);
    const useCompactTeamGrid = compactTeamQuery.matches;

    const filtered = orderedTeam.filter((member) => {
      if (!hasActiveFilter && !useCompactTeamGrid && member.name === featuredMemberName) return false;
    ...
    if (featuredRoot) {
      featuredRoot.hidden = hasActiveFilter || useCompactTeamGrid;
    }
    ...
    const renderedCards = [
      ...(featuredRoot?.querySelectorAll(".team-member-card") || []),
      ...grid.querySelectorAll(".team-member-card"),
    ];

    renderedCards.forEach((card) => {
      card.classList.remove("reveal");
      card.classList.add("visible", "reveal-visible");
    });
  };

  roleFilter?.addEventListener("change", draw);
  classFilter?.addEventListener("change", draw);
  compactTeamQuery.addEventListener("change", draw);
  draw();
}

function initTeamSections() {
  if (document.querySelector("[data-team-grid]")) {
    renderTeamPage();
    return;
  }
